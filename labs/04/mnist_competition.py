...
def main(args: argparse.Namespace):
    if args.predict is None:
        ...
        pipe = sklearn.pipeline.Pipeline([
            ...
            ("MLP", sklearn.neural_network.MLPClassifier(hidden_layer_sizes=[20], verbose=True, max_iter=200))
            ])
        
        grid = sklearn.model_selection.GridSearchCV(pipe, [{
            'MLP__hidden_layer_sizes' : [[20], [100], [200], [500]],
            'MLP__alpha' : [0.00001, 0.001, 0.1]
        }],
        cv=3,
        verbose=3)
